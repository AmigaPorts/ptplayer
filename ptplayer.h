...
void ASM mt_install_cia(REG(a6, APTR custom),
	REG(a0, APTR *AutoVecBase), REG(d0, UBYTE PALflag));
...
void ASM mt_remove_cia(REG(a6, APTR custom));
...
void ASM mt_init(REG(a6, APTR custom),
	REG(a0, APTR TrackerModule), REG(a1, APTR Samples),
...
void ASM mt_end(REG(a6, APTR custom));
...
void ASM mt_soundfx(REG(a6, APTR custom),
	REG(a0, APTR SamplePointer), REG(d0, UWORD SampleLength),
...
void ASM mt_playfx(REG(a6, APTR custom),
...
void ASM mt_musicmask(REG(a6, APTR custom),
...
void ASM mt_mastervol(REG(a6, APTR custom),
...
void ASM mt_music(REG(a6, APTR custom));
